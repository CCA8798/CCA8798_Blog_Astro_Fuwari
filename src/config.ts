...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/blurred-banner.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
		position: "center", // Equivalent to object-position, only supports 'top', 'center', 'bottom'. 'center' by default
		credit: {
			enable: false, // Display the credit text of the banner image
			text: "不会起名の捌拐玖捌🍥", // Credit text to be displayed
	...
	links: [
		{
			...
			url: "https://x.com/CCA8798suki",
		},
		{
			name: "BiliBili",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/688231358",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/CCA8798",
		},
	],
};
